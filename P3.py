...
plt.savefig('CoreTruss_' + title + '.png',dpi=100)
...
plt.legend(loc='upper left', fontsize=25)
ax.set_ylabel('Triangle Count', fontsize=40)
ax.set_xlabel('Core Number', fontsize=40)
ax.tick_params(labelsize=30)
plt.savefig('CoreTri_' + title + '.png',dpi=100)
...
ax.tick_params(labelsize=30)
plt.savefig('DegTruss_' + title + '.png',dpi=100)
...
ax.set_xlabel('Degree', fontsize=40)
ax.tick_params(labelsize=30)
plt.savefig('DegTri_' + title + '.png',dpi=100)
